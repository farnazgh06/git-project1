...
public class questionsPage {
    ...
    public void create(JFrame frame) {
        ...
        // Question 1
        JLabel question1 = new JLabel("How attractive do you think the software's user interface is?");
        question1.setFont(new Font("Arial",Font.BOLD, 13));
        ...
        question2.setFont(new Font("Arial",Font.BOLD, 13));
        ...
        question3.setFont(new Font("Arial",Font.BOLD, 13));
        ...
        question4.setFont(new Font("Arial",Font.BOLD, 13));
